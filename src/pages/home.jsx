        ...
        <>
            ...
            <div className="flex flex-row bg-[#3573b5] text-[white]">
                <div className="flex flex-col">
                    ...
                    <h2 className="text-[22px] ml-[65px] pt-[3px]">Simple browse through our extensive list of trusted doctors,<br />schedule your appointment hassle-free.</h2>
                    <button className="bg-neutral-100 text-base transition-colors duration-300 ease-in w-[267px] ml-[71px] mt-[34px] mb-[35px] px-[50px] py-[20px] rounded-[15px] border-0 hover:bg-[rgb(34,159,34)] hover:text-white hover:rounded-none font-sans">
                        <NavLink to="/About" className="no-underline text-[#333] font-[bold] cursor-pointer hover:text-[white] text-[2xl]">BOOK APPOINTMENT</NavLink>
                    </button>
                </div>
                <div className="">
                    <img className="h-[584px] w-[827px] " src={index} alt="Home image" />
                </div>
            </div>
            <Speciality />
            <Expert />
