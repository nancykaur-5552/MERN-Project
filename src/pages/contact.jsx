...
const contact = () => {
    ...
    return (
        <>
            ...
            <div className="w-full h-[57vh] flex items-center justify-center flex-col pt-[4em]">
                <p><iframe
            ...
            <div className="flex flex-row justify-center items-center text-center gap-[61px] pt-[4em]">
            ...
            <div className="flex justify-center items-center pt-[4em]">
                <div className="w-4/5 max-w-[800px] bg-[rgba(183,178,178,0.13)] flex gap-[19px]">
                    ...
                    <form className="flex flex-col gap-[8px] pl-3 pt-[21px]">
                        ...
                        <input className="w-[24vw] h-[7vh] border pl-3 rounded-sm border-solid border-[rgb(204,201,201)]" type="text" placeholder="Your Name" />
                        <label htmlFor="Email"></label>
                        <input className="w-[24vw] h-[7vh] border pl-3 rounded-sm border-solid border-[rgb(204,201,201)]"type="email" placeholder="Your Email" />
                        <label htmlFor="Subject"></label>
                        <input className="w-[24vw] h-[7vh] border pl-3 rounded-sm border-solid border-[rgb(204,201,201)]"type="text" placeholder="Subject" />
                        <label htmlFor="message"></label>
                        <textarea className="w-[24vw] h-[20vh] border pl-3 pt-3 rounded-sm border-solid border-[rgb(204,201,201)]"placeholder="Message"></textarea>
