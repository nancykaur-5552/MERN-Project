  ...
  return (
        ...
        <div className="flex flex-row w-[61vw] gap-[33px] h-[61vh] bg-[#9491911b]">
            ...
            <div className="pr-5 pt-[2em]">
                <div className="buttons">
                    <button className='h-[5vh] w-[8vw] bg-[#5798dd] text-xl gap-2.5 p-[5px] border-none hover:bg-[rgb(34,159,34)]' onClick={info}>Info</button>
                    <button className='h-[5vh] w-[8vw] bg-[#5798dd] text-xl gap-2.5 p-[5px] border-none hover:bg-[rgb(34,159,34)]' onClick={skill}>Skills</button>
                </div>
    ...
    className="text-center bg-no-repeat bg-cover text-[white] pt-[3em]">
        ...
        <div className="flex flex-row flex-wrap justify-center items-center gap-[5px]">
            <NavLink to='/Richard' className="no-underline text-[white] py-[2em]">
            ...
            <NavLink to='/JohnMillar' className="no-underline text-[white] py-[2em]">
            ...
            <NavLink to='/Theresa' className="no-underline text-[white] py-[2em]">
                <img className='h-[33vh]  rounded-[50%] hover:transition-[0.3s] hover:shadow-[2px_5px_4px_5px_white] hover:scale-90' src={pic4} alt="pic2"/>
                <h2>Dr. Theresa Hamilton</h2>
                <h3>Dermatologist</h3>
            </NavLink>
            <NavLink to='/Brittany' className="no-underline text-[white] py-[2em]">
                <img className='h-[33vh]  rounded-[50%] hover:transition-[0.3s] hover:shadow-[2px_5px_4px_5px_white] hover:scale-90' src={pic5} alt="pic2"/>
