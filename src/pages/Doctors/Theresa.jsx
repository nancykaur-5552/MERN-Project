            ...
            <div style={{ backgroundImage: `url(${expert})` }}
                ...
                <div className="flex flex-row flex-wrap justify-center items-center gap-[20px]">
                    ...
                    <NavLink to='/Doctors/JohnMillar' className="text-[white] py-[2em] no-underline">
                        <img className='h-[30vh]  rounded-[50%] hover:transition-[0.3s] hover:shadow-[2px_5px_4px_5px_white] hover:scale-90' src={pic3} alt="pic2" />
                        <h2>Dr. John Millar</h2>
                        <h3>Gastroenterologist</h3>
                    </NavLink>
                    <NavLink to='/Doctors/Henry' className="text-[white] py-[2em] no-underline">
                        <img className='h-[30vh]  rounded-[50%] hover:transition-[0.3s] hover:shadow-[2px_5px_4px_5px_white] hover:scale-90' src={pic6} alt="pic2" />
