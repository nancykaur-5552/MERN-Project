...
import {Theresa, JohnMillar, Richard, info, skill} from './John'
const Brittany = () => {
  function Henry() {
    window.open('Henry', '_self');
  }
  return (
    <>
      <Navbar/>
      ...
      <div className="container">
        <div className="box">
          <div className="left-side">
            <img src="../All Doctors/pic5.png" alt="Brittany" />
          </div>
      ...
      <div className="expert">
        ...
        <div className="doctors">
          ...
          <div className="doc 4" onClick={Henry}>
