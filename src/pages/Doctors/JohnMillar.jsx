            ...
            <div className="flex flex-wrap flex-row justify-center items-center py-[3em]">
                <div className="flex flex-row w-[61vw] gap-[33px] h-[61vh] bg-[#9491911b]">
                    <div className="left-side">
                        <img className='h-[61vh] w-[25vw]' src={pic3} alt="John" />
                    </div>
                    <div className="pr-5 pt-[2em]">
                        ...
                        <div className="details">
                            ...
                            <h3 className='text-[rgb(34,159,34)]'>Gastroenterologist</h3>
                            <div>{para}</div>
            ...
            <div style={{ backgroundImage: `url(${expert})` }}
                ...
                <div className="flex flex-row flex-wrap justify-center items-center gap-[20px]">
                    ...
                    <NavLink to='/Doctors/Henry' className="text-[white] py-[2em] no-underline">
                        <img className='h-[30vh]  rounded-[50%] hover:transition-[0.3s] hover:shadow-[2px_5px_4px_5px_white] hover:scale-90' src={pic6} alt="pic6" />
